...
whenever a \verb+-R+ option starting with \verb+$p+, \verb+$q+, \verb+$U+ or
\verb+$V+ is given (which is the default when no \verb+-R+ is given), and no
statistical output or counts are requested.%
