...
Secondly, a \textitidx{group generator list} can be specified by enclosing
...
Thirdly, rows can be read from a file --- the 
...
The fourth way is with a command invocation:
...
\subsection{Named music patterns}
...
to take about 6.4\ s, and the latter, 71.2\ s --- a factor of 11 slower.%
...
\section{Printing methods: \texttt{printmethod}}\label{printmethod}
\section{Analysing music: \texttt{musgrep}}\label{musgrep}
\section{Searching for touches: \texttt{touchsearch}}\label{touchsearch}
