...
reach lead.  For example methods such as Very Little Bob Minor (in which the 
third hunts between thirds place and fourths) can be found with \verb+-Z3-4+, 
and Double Bishopstoke Little Surprise Major (in which the treble treble-dodges
between thirds and sixths) can be found with \verb+-G1+ \verb+-Z3-6+.
