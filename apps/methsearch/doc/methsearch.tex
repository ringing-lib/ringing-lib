...
Libraries are only loaded if required.  This currently happens if the
\verb+--filter-lib+ option is given (\sref{filtering}), or if the \verb+$n+,
\verb+$N+ or \verb+$i+ variables are used (\sref{variables}).
