...
\verb+--status-freq+ option, and the use of that option implies \verb+-u+.
...
achieved with \verb+-FP=124365 -FP=132546 -FP=132465+ \verb+-Fh+.  (These three 
...
\item Comma operator (for sequencing): \verb+,+ (\sref{oper}).
