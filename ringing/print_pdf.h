...
// Copyright (C) 2002, 2020, 2021 Martin Bright <martin@boojum.org.uk> and
...
public:
  rule_pdf(float x, float y, float l, const printrow::options::line_style &s)
    : x(x), y(y), l(l), style(s) {}
